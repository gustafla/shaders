...
void main() {
    ...
    vec2 point1 = vec2(sin(iGlobalTime*0.05)*0.5+0.5, cos(iGlobalTime)*0.5+0.5);
    vec2 point2 = vec2(sin(iGlobalTime*0.1+PI)*0.5+0.5, cos(iGlobalTime*0.3+PI)*0.5+0.5);
    ...
    */
    ...
    if (pos.y+lineSizeHalf > min(point1.y, point2.y) && 
        pos.y-lineSizeHalf < max(point1.y, point2.y) && 
        pos.x+lineSizeHalf > min(point1.x, point2.x) && 
        pos.x-lineSizeHalf < max(point1.x, point2.x)) {
