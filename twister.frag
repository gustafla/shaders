...
void main() {			
    ...
    //float a = iGlobalTime + sin(iGlobalTime*0.1)*pos.y*2.0 + sin(pos.y*3.0)*0.8;
    ...
    col.r += alpha.x * shade.x;
    col.g += alpha.y * shade.y;
    col.rg += alpha.z * shade.z;
    col.b += alpha.w * shade.w;

    col.a = dot(alpha, alpha)*0.1;
